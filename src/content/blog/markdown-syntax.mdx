...
```mdx
<Figure
    src="/assets/images/blog/markdown-hero.webp"
    alt="Desk setup, primarily green and muted colors. forest screen monitor, white PC, tablet and a shelf with greenery decorations above."
...
If the image doesn't load, at least the alt text will politely explain what _should_ have been there. For blog posts use `/assets` inside `/public` for images.
